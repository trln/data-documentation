...
If there is NO $bcdgo in the field, treat the $a like a normal string value -- extract as is from the record.
====
...
If there is NO $a in the field, provide punctuation between subfields

[cols=2*,options=header]
|====================
| subfield delimiter | preceding punctuation
| b | -- or em dash
| c | -- or em dash
| d | comma space
| g | (if not first subfield) -- or em dash
|====================
...
===== Argot
*Same processing rule as previous example*
...
If there is NO $a or $b in the field, and field does not begin with a $g, provide a contextualizing label for field. 
====
...
----
{
  "note_production_credits":[
    {
      "value":"Baby face: editing, Howard Bretherton ; photography, James Van Trees."
    },
    {
    "value":"Red-headed woman: photography, Harold Rosson ; editing, Blanche Sewell."
    },
    {
    "value":"Waterloo Bridge: cinematographer, Arthur Edeson ; editor, Clarence Kolster, Maurice Pivar ; music, Val Burton."
    }
  ]
}
----
